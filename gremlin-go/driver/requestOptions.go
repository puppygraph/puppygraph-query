...
func (builder *RequestOptionsBuilder) AddAliases(key string, aliases interface{}) *RequestOptionsBuilder {
	if builder.aliases == nil {
		builder.aliases = make(map[string]interface{})
	}
	builder.aliases[key] = aliases
	return builder
}
...
func (builder *RequestOptionsBuilder) Create() RequestOptions {
	...
	requestOptions.aliases = builder.aliases
